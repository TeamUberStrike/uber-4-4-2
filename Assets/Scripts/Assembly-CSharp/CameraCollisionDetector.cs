...
public class CameraCollisionDetector
{
	...
	public void OnGUI()
	{
		GUI.Label(new Rect(200f, 200f, 200f, 20f), "Left HitResult: " + _lHitResult);
		if (_lHitResult)
		{
			GUI.Label(new Rect(200f, 220f, 200f, 20f), "Hit point: " + _lRaycastInfo.point);
		}
		GUI.Label(new Rect(400f, 200f, 200f, 20f), "Right HitResult: " + _rHitResult);
		if (_rHitResult)
		{
			GUI.Label(new Rect(400f, 220f, 200f, 20f), "Hit point: " + _rRaycastInfo.point);
		}
	}
}
