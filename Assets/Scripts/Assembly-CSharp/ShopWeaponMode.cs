...
public class ShopWeaponMode : FpsGameMode
{
	...
	protected override void OnCharacterLoaded()
	{
		...
		Singleton<WeaponController>.Instance.ShowWeapon(LoadoutSlotType.WeaponPickup);
		MonoRoutine.Start(MoveQuickItemsHud());
	}
	...
	private IEnumerator SimulateGameFrameUpdate()
	{
		...
		Singleton<WeaponsHud>.Instance.Dispose();
	}

	private IEnumerator MoveQuickItemsHud()
	{
