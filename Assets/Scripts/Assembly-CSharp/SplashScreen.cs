...
public class SplashScreen : MonoBehaviour
{
	...
	private void OnGUI()
	{
		...
		if (!GlobalSceneLoader.IsError)
		{
			...
			{
				Vector2 v = label_loading.CalcSize(new GUIContent("Connecting..."));
				GUITools.LabelShadow(new Rect(0f, Screen.height - 150, Screen.width, v.Height()), "Connecting...", label_loading, label_loading.normal.textColor);
			}
