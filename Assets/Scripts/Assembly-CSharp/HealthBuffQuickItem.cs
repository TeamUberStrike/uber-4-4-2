...
public class HealthBuffQuickItem : QuickItem
{
	private class ActivatedState : IState
	{
		...
		private void SendHealthIncrease()
		{
			...
			HealthIncreaseEvent healthIncreaseEvent = new HealthIncreaseEvent();
			healthIncreaseEvent.Health = num;
			CmuneEventHandler.Route(healthIncreaseEvent);
		}
	}
	...
	protected override void OnActivated()
	{
		...
		Singleton<QuickItemSfxController>.Instance.ShowThirdPersonEffect(GameState.LocalPlayer.Character, QuickItemLogic.HealthPack, _config.RobotLifeTimeMilliSeconds, _config.ScrapsLifeTimeMilliSeconds, _config.IsHealInstant);
		GameState.CurrentGame.ActivateQuickItem(QuickItemLogic.HealthPack, _config.RobotLifeTimeMilliSeconds, _config.ScrapsLifeTimeMilliSeconds, _config.IsHealInstant);
		machine.SetState(1);
	}
