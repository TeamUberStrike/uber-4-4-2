		...
		if (GameState.HasCurrentSpace)
		{
			if (LevelTutorial.Exists)
			{
				...
				if ((bool)LevelTutorial.Instance.NPC)
				{
					...
					LevelTutorial.Instance.NPC.animation.enabled = true;
					LevelTutorial.Instance.NPC.animation.Play(AnimationIndex.HomeSmallGunIdle.ToString());
					LevelTutorial.Instance.NPC.animation.Stop();
