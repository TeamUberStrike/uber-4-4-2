...
public class CreditBundlesShopGui
{
	...
	public void Draw(Rect position)
	{
		...
		{
			WaitingTexture.Draw(new Vector2((position.width - 17f) / 2f, position.x + 50f));
		}
		else
		{
	...
	{
		if (GUI.Button(new Rect(81f, 51f, position.width - 110f, 20f), new GUIContent(bundleUnityView.Price, "Buy the " + bundleUnityView.BundleView.Name + " pack."), BlueStonez.buttongold_medium))
		{
			GUITools.Clicked();
