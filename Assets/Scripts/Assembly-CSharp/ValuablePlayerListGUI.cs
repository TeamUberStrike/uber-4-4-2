...
internal class ValuablePlayerListGUI
{
	...
	public void SetSelection(int index)
	{
		...
		OnSelectionChange(Singleton<EndOfMatchStats>.Instance.Data.MostValuablePlayers[_curSelectedPlayerIndex]);
	}
	...
	private void DrawRankingListContent(Rect rect, float[] columnWidthPercent)
	{
		...
		_playerListViewHeight = Singleton<EndOfMatchStats>.Instance.Data.MostValuablePlayers.Count * 32;
		...
		float num2 = 0f;
		int num3 = 0;
		while (Singleton<EndOfMatchStats>.Instance.Data != null && num3 < Singleton<EndOfMatchStats>.Instance.Data.MostValuablePlayers.Count)
		{
	...
	{
		StatsSummary statsSummary = Singleton<EndOfMatchStats>.Instance.Data.MostValuablePlayers[rank];
