...
public class ArmorBuffQuickItem : QuickItem
{
	private class ActivatedState : IState
	{
		...
		private void SendHealthIncrease()
		{
			...
			ArmorIncreaseEvent armorIncreaseEvent = new ArmorIncreaseEvent();
			armorIncreaseEvent.Armor = num;
			CmuneEventHandler.Route(armorIncreaseEvent);
		}
	}
	...
	protected override void OnActivated()
	{
		...
		Singleton<QuickItemSfxController>.Instance.ShowThirdPersonEffect(GameState.LocalPlayer.Character, QuickItemLogic.ArmorPack, _config.RobotLifeTimeMilliSeconds, _config.ScrapsLifeTimeMilliSeconds, _config.IsInstant);
		GameState.CurrentGame.ActivateQuickItem(QuickItemLogic.ArmorPack, _config.RobotLifeTimeMilliSeconds, _config.ScrapsLifeTimeMilliSeconds, _config.IsInstant);
		machine.SetState(1);
	}
