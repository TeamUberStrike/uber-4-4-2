...
public static class ColorScheme
{
	...
	public static readonly Color ChatNameQAUser = ColorConverter.RgbToColor(161f, 134f, 190f);

	public static readonly Color ChatNameSeniorQAUser = ColorConverter.RgbToColor(153f, 0f, 255f);
