...
public class ExplosiveGrenadeQuickItem : QuickItem, IProjectile, IGrenadeProjectile
{
	...
	public IGrenadeProjectile Throw(Vector3 position, Vector3 velocity)
	{
		...
		if ((bool)explosiveGrenadeQuickItem)
		{
			...
			Collider explosiveCollider = explosiveGrenadeQuickItem.GetComponent<Collider>();
			if (explosiveCollider != null && explosiveCollider.material != null)
			{
				explosiveCollider.material.bounciness = _config.Bounciness;
			}
